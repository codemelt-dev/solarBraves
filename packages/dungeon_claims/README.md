...
contract `dungeon_claims` via Soroban RPC.
...
soroban contract bindings ts \
  ...
  --contract-id CAQKXG6GR7E2UY7N5RSD6S6AGI5SLADE2U7UKSYAWLYKHFIZC5IO5LCJ \
  --output-dir ./path/to/dungeon_claims
```
...
```json
"dependencies": {
  "dungeon_claims": "./path/to/this/folder"
}
```
...
```json
"scripts": {
  "postinstall": "soroban contract bindings ts --rpc-url http://localhost:8000/rpc --network-passphrase \"Standalone Network ; February 2017\" --id CAQKXG6GR7E2UY7N5RSD6S6AGI5SLADE2U7UKSYAWLYKHFIZC5IO5LCJ --name dungeon_claims"
}
```
...
```js
import { Contract, networks } from "dungeon_claims"
