...
contract `nft_enumerable_example` via Soroban RPC.
...
soroban contract bindings ts \
  ...
  --contract-id CBE3HDNCWQMRM3OP5BKIBLTAYINEOCHAWVET4VEI76IAFEJP36KRQKXS \
...
```json
"scripts": {
  "postinstall": "soroban contract bindings ts --rpc-url http://localhost:8000/rpc --network-passphrase \"Standalone Network ; February 2017\" --id CBE3HDNCWQMRM3OP5BKIBLTAYINEOCHAWVET4VEI76IAFEJP36KRQKXS --name nft_enumerable_example"
}
```
