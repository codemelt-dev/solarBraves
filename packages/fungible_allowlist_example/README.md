...
contract `fungible_allowlist_example` via Soroban RPC.
...
soroban contract bindings ts \
  ...
  --contract-id CD5D7ABWG3Y3ZCI3TBM2R5AHL3U526XPOFBSWXIP3KT4MQ4O63YVEZXL \
...
```json
"scripts": {
  "postinstall": "soroban contract bindings ts --rpc-url http://localhost:8000/rpc --network-passphrase \"Standalone Network ; February 2017\" --id CD5D7ABWG3Y3ZCI3TBM2R5AHL3U526XPOFBSWXIP3KT4MQ4O63YVEZXL --name fungible_allowlist_example"
}
```
