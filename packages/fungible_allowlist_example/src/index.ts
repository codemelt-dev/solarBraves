...
export interface Client {
	...
	grant_role: (
		{
			...
			role,
			caller,
		}: { account: string; role: string; caller: string },
		options?: MethodOptions,
	) => Promise<AssembledTransaction<null>>
	 ...
	 */
	renounce_role: (
		{ role, caller }: { role: string; caller: string },
		options?: MethodOptions,
	) => Promise<AssembledTransaction<null>>
...
export class Client extends ContractClient {
	...
	constructor(public readonly options: ContractClientOptions) {
		super(
			new ContractSpec([
				"AAAAAAAAAAAAAAANX19jb25zdHJ1Y3RvcgAAAAAAAAUAAAAAAAAABG5hbWUAAAAQAAAAAAAAAAZzeW1ib2wAAAAAABAAAAAAAAAABWFkbWluAAAAAAAAEwAAAAAAAAAHbWFuYWdlcgAAAAATAAAAAAAAAA5pbml0aWFsX3N1cHBseQAAAAAACwAAAAA=",
				...
				"",
				...
				"",
				...
				"",
				"",
