...
soroban contract bindings ts \
  ...
  --contract-id CABTPCVFPMPMDFNUVNM56SOZPGBREKJ35IBI4N3ZKWH5D4MB7RUBX2VS \
...
```json
"scripts": {
  "postinstall": "soroban contract bindings ts --rpc-url http://localhost:8000/rpc --network-passphrase \"Standalone Network ; February 2017\" --id CABTPCVFPMPMDFNUVNM56SOZPGBREKJ35IBI4N3ZKWH5D4MB7RUBX2VS --name guess_the_number"
}
```
