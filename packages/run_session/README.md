...
contract `run_session` via Soroban RPC.
...
soroban contract bindings ts \
  ...
  --contract-id CCB7LR3SQPFUVS4LKQBXUGODU5PIX5RSMK5YACBK7DQFBVJC62BW432T \
  --output-dir ./path/to/run_session
```
...
```json
"dependencies": {
  "run_session": "./path/to/this/folder"
}
```
...
```json
"scripts": {
  "postinstall": "soroban contract bindings ts --rpc-url http://localhost:8000/rpc --network-passphrase \"Standalone Network ; February 2017\" --id CCB7LR3SQPFUVS4LKQBXUGODU5PIX5RSMK5YACBK7DQFBVJC62BW432T --name run_session"
}
```
...
```js
import { Contract, networks } from "run_session"
